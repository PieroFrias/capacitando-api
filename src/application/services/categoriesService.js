class categoriesService {
  ...
  async getAllCategories(dataFilter) {
    try {
      ...
      throw new Error(
        "(SERVICE - getAllCategories) Error al obtener las categorias: " +
          error.message
      );
    }
  }
  ...
  async getCategoryDetail(id) {
    try {
      ...
      throw new Error(
        "(SERVICE - getCategoryDetail) Error al obtener la categoria: " +
          error.message
      );
    }
  }
  ...
  async createCategory(dataCategory) {
    try {
      ...
      throw new Error(
        "(SERVICE - createCategory) Error al crear la categoria: " +
          error.message
      );
    }
  }
  ...
  async updateCategory(id, dataCategory) {
    try {
      const category = await this.categoriesRepository.updateCategory(
        id,
        dataCategory
      );
      return category;
      ...
      throw new Error(
        "(SERVICE - updateCategory) Error al actualizar la categoria: " +
          error.message
      );
    }
  }
  ...
  async changeStatusCategory(id) {
    try {
      ...
      throw new Error(
        "(SERVICE - changeStatusCategory) Error al cambiar el estado de categoria: " +
          error.message
      );
    }
  }
